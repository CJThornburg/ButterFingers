...
Revision ID: bdac6cf8d524
Revises:
Create Date: 2023-08-09 16:00:59.984800
...
def upgrade():
    ...
    sa.Column('userName1', sa.String(length=20), nullable=True),
    sa.Column('userName2', sa.String(length=20), nullable=True),
    sa.Column('status', sa.String(length=10), nullable=True),
    sa.Column('friendRequestTo', sa.Integer(), nullable=True),
